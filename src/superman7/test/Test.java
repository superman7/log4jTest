...
public class Test {
	...
	public static void main(String[] args) {
		...
		for(int i = 0; i < 15; i++){
			...
			logger.error("Did it again!"+i);   //error级别的信息，参数就是你输出的信息
			logger.info("我是info信息"+i);    //info级别的信息
			logger.debug("我是debug信息"+i);
			logger.warn("我是warn信息"+i);
			logger.fatal("我是fatal信息"+i);
